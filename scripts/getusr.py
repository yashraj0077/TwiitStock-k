...
open("/home/twittstocks/public_html/data/tokens.temp",'a').close()
os.system("chmod 777 /home/twittstocks/public_html/data/tokens.temp")
out = ""
lines = open("/home/twittstocks/public_html/data/tokens.temp",'r').read().split("\n")
for ln in lines:
    if "@" in ln:
        out += ln + "\n"
    else:
        if len(ln.split("|")) == 3:
            ...
            predat = ""
            etry = open("/home/twittstocks/public_html/data/tokens.temp",'r').read().split("\n")[-2].split("|")
            for l in etry:
                if l == etry[-1]:
                    predat += "@"+usrn
                else:
...
open("/home/twittstocks/public_html/data/tokens.temp",'w').write(out)
