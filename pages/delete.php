...
<body>
        ...
        <div class="delete-box">
            ...
            <form method="post" action="">
                ...
                <select class="dropdown" name="selected_token">
                    <?php
                    exec("python3 /public_html/scripts/checktkn.py");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $file = '/public_html/data/urlin.temp';
        exec("chmod 777 /public_html/data/urlin.temp");
        file_put_contents($file, $tweet_url . "|" . $selected_token . PHP_EOL, FILE_APPEND);
        exec("python3 /public_html/scripts/delete.py");	
        unlink($file);
        $fl = fopen("/public_html/data/urlin.temp", 'w');
        fclose($fl);
    }
    ?>
</body>
